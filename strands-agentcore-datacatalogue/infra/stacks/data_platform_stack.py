...
class DataPlatformStack(Stack):
    """Provisions the core data-plane resources for the demo catalogue."""
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.data_bucket = s3.Bucket(
            self,
            "DataBucket",
            bucket_name=f"demo-data-{Aws.ACCOUNT_ID}",
        ...
        self.athena_results_bucket = s3.Bucket(
            self,
            "AthenaResultsBucket",
            bucket_name=f"demo-athena-results-{Aws.ACCOUNT_ID}",
            removal_policy=RemovalPolicy.DESTROY,
            auto_delete_objects=True,
        )
        ...
        self.kb_source_bucket = s3.Bucket(
            self,
            "KbSourceBucket",
            bucket_name=f"demo-kb-source-{Aws.ACCOUNT_ID}",
            removal_policy=RemovalPolicy.DESTROY,
            auto_delete_objects=True,
        )
        ...
        glue_db = glue.CfnDatabase(
            ...
            database_input=glue.CfnDatabase.DatabaseInputProperty(
                name="agency_data_catalogue",
            ),
        )
        self._glue_database_name = "agency_data_catalogue"
        ...
        self._athena_workgroup_name = "demo-athena-wg"
